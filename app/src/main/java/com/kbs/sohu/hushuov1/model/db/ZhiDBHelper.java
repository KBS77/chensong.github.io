...
public class ZhiDBHelper extends SQLiteOpenHelper {

    private Context mContext;

    public ZhiDBHelper(Context context, String name) {
        super(context, name, null, 1);
        mContext = context;
    }

    public ZhiDBHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
