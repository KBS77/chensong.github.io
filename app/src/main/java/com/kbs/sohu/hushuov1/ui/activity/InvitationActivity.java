...
import com.kbs.sohu.hushuov1.ui.adapter.InviteAdapter;
...
public class InvitationActivity extends AppCompatActivity {
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InvitationActivity.this, "拒绝成功了", Toast.LENGTH_SHORT).show();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InvitationActivity.this, "拒绝失败了", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InvitationActivity.this, "接受邀请", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        lv_invite = (ListView)findViewById(R.id.lv_new_friend);
    }
